...
class ResponseBuilder extends ResponseBuilderBase
{
	 ...
	 *
	 * @return \Taxionus\ResponseBuilder\ResponseBuilder
	 *
	 * @throws Ex\InvalidTypeException
	 * @throws Ex\MissingConfigurationKeyException
	 * @throws Ex\NotIntegerException
	...
	{
		Validator::assertIsType('json_opts', $json_opts, [
			Type::INTEGER,
			Type::NULL
		]);
	...
	{
		Validator::assertIsType('$debug_data', $debug_data, [
			Type::ARRAY,
			Type::NULL
		]);
	...
	{
		Validator::assertIsType('message', $msg, [
			Type::STRING,
			Type::NULL
		]);
		$this->message = $msg;
