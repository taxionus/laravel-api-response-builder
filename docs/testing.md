...
use Taxionus\ResponseBuilder\ApiCodesHelpers;
class TestableApiCodes extends \App\ApiCodes
{
    use ApiCodesHelpers;
}

use Taxionus\ResponseBuilder\Tests\Traits\ApiCodesTests;
...
use Taxionus\ResponseBuilder\Tests\Traits\TestingHelpers;
